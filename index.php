                ...
                <ul class="text-sm font-medium text-gray-900 bg-[#fdfdfd] border border-gray-300 rounded-lg dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                    <li class="w-full border-b border-gray-200 rounded-t-lg dark:border-gray-600">
                        <div class="flex items-center ps-3">
                            ...
                            <label for="yes-marriage-radio" class="w-full py-3 ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">している</label>
                        </div>
                    </li>
                    <li class="w-full border-b border-gray-200 rounded-t-lg dark:border-gray-600">
                        <div class="flex items-center ps-3">
                            ...
                            <label for="no-marriage-radio" class="w-full py-3 ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">していない</label>
                        </div>
                    </li>
                </ul>
            </div>
